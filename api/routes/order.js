...
import { verifyToken, verifyTokenAndAdmin, verifyTokenAndAuthorization } from './verify'
...
//UPDATE
router.put('/:id', verifyTokenAndAdmin, asyncWrapper(async (req, res) => {
...
// DELETE
router.delete('/:id', verifyTokenAndAdmin, asyncWrapper(async () => {
    await Order.findByIdAndDelete(req.params.id)
    res.status(200).json('Order has been deleted...')
}))

// GET USER ORDERS
router.get('/find/:userId', verifyTokenAndAuthorization, asyncWrapper(async (req, res) => {
...
//GET MONTHLY INCOME
router.get('/income', verifyTokenAndAdmin, asyncWrapper(async (req, res) => {
